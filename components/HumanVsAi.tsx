...
export default function HumanVsAi() {
  ...
  return (
    <section className="py-20 relative overflow-hidden" id="human-vs-ai" style={{ backgroundColor: "var(--bg)" }}>
      {/* Accent glows */}
      <div
        aria-hidden
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <Reveal delay={0.2}>
            <div 
              ...
              style={{
                borderColor: "#E2E8F0",
                boxShadow: "0 1px 3px rgba(15,23,42,0.02), 0 10px 30px rgba(15,23,42,0.02)",
              }}
            >
              {/* Table Header */}
              <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-slate-50 border-b border-slate-200 text-xs font-bold uppercase tracking-wider text-slate-500">
                <div className="col-span-4 md:col-span-3">Comparison</div>
                <div className="col-span-8 md:col-span-4 text-rose-600">Human Employee</div>
                <div className="hidden md:block md:col-span-5 text-[#4F46E5]">AI Employee (System)</div>
              </div>
              ...
              <div className="divide-y divide-slate-100">
                {comparisonData.map((row) => (
                  <div key={row.metric} className="grid grid-cols-12 gap-4 px-6 py-5 items-start text-xs sm:text-sm">
                    {/* Metric Name */}
                    <div className="col-span-4 md:col-span-3 font-semibold text-slate-800">
                      {row.metric}
                    </div>
                    ...
                    <div className="col-span-12 md:col-span-5 space-y-1 mt-3 md:mt-0 pt-3 md:pt-0 border-t border-dashed border-slate-100 md:border-t-0">
                      <div className="md:hidden text-[9px] font-bold uppercase tracking-wider text-[#4F46E5] mb-1">
          ...
          <div className="mt-8 text-center">
            <Reveal delay={0.25}>
              <div className="inline-flex flex-wrap items-center justify-center gap-4">
                <a
                  href={`https://wa.me/919050486448?text=${whatsappMsg}`}
                  target="_blank"
