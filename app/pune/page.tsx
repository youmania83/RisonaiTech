...
export const metadata: Metadata = {
  title: "AI Automation Company in Pune | Workflows & AI Agents",
  description:
    "RisonAI Tech is a leading AI automation company in Pune. We build custom AI chatbots, WhatsApp bots, voice agents, and CRM workflows. Get a free demo!",
  keywords: [
    "AI Automation Company in Pune",
    "AI Chatbot Development Pune",
    "Chatbot Solutions Pune",
    "Voice AI Pune",
    "Business Automation Pune",
    "AI Calling Agent Pune",
    "Workflow Automation Pune",
    "Customer Support Automation Pune",
    "WhatsApp Chatbot Pune",
    "AI Solutions Pune",
    "Conversational AI Pune",
  ],
  alternates: { canonical: "/pune" },
  openGraph: {
    title: "AI Automation Company in Pune | RisonAI Tech",
    description:
      "Deploy custom AI agents, n8n workflow pipelines, and WhatsApp Business integrations in Pune, Pimpri-Chinchwad, Chakan. Drive efficiency and cut overhead.",
  ...
  twitter: {
    ...
    title: "AI Automation Company in Pune | RisonAI Tech",
    description:
      "RisonAI Tech builds context-aware AI agents, automated booking bots, and CRM systems for Pune businesses. Cut support queues by 70%.",
    images: ["https://risonaitech.com/opengraph-image"],
  },
};

const localDistricts = ["Hinjawadi","Magarpatta","Baner","Viman Nagar","Koregaon Park","Senapati Bapat Road"];
const nearbyCities = ["Pimpri-Chinchwad","Chakan","Hadapsar","Lonavala"];

const industriesList = [
  {
    name: "IT & SaaS Startups",
    icon: Cpu,
    text: "Software developers in Hinjawadi and Baner automate client onboarding, support ticket triage, and developer documentation searches."
  },
  {
    name: "Automotive & Mfg",
    icon: Building,
    text: "Manufacturing units in Chakan and Pimpri automate B2B dealer communications, order status, and dispatch schedules over WhatsApp."
  },
  {
    name: "Real Estate & Dev",
    icon: HomeIcon,
    text: "Developers in Viman Nagar and Koregaon Park qualify lead budgets and schedule site tours directly into sales calendars."
  },
  {
    name: "Retail & E-commerce",
    icon: ShoppingBag,
    text: "E-commerce brands in Pune automate retail support, package tracking updates, cart recovery codes, and refund tickets."
  },
  {
    name: "Healthcare & Clinics",
    icon: Activity,
    text: "Hospitals and dental clinics in Pune automate patient booking, pre-visit instructions, and intake document collections."
  },
  {
    name: "Logistics & Transport",
    icon: Truck,
    text: "Logistics operations near Pune automate driver check-ins, delivery updates, and supplier notifications over WhatsApp."
  }
];
...
const factualBenchmarks = [
  ...
  {
    stat: "3x increase in qualified lead capture for Pune sales teams.",
  ...
  {
    stat: "60% reduction in document review time for operations groups in Hinjawadi.",
...
const localBusinessSchemaData = {
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress: "Hinjawadi, Magarpatta, Baner",
...
const pageSchema = graph(
  ...
  placeSchema({
    ...
    url: "/pune",
    description:
      "RisonAI Tech builds custom AI automation, SaaS products, CRM workflows, and chatbot systems for Pune enterprises.",
    latitude: 18.5204,
    longitude: 73.8567
  }),
  serviceSchema({
    id: "ai-automation-pune",
    name: "AI Automation Services in Pune",
    serviceType: "AI Automation",
    description:
      "End-to-end AI automation solutions, custom RAG chatbots, voice calling agents, and CRM integrations for Hinjawadi and Magarpatta enterprises.",
    url: "/pune",
  ...
  return (
    <>
        ...
        <div className="container-site relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            <span className="label-pill mb-6 inline-flex items-center gap-1.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 px-3 py-1 rounded-full text-xs font-semibold">
              <MapPin size={12} /> Pune · Pimpri-Chinchwad · Chakan · Hinjawadi
            </span>
            <h1 className="font-display text-5xl font-extrabold tracking-tight sm:text-7xl">
              AI Automation Company in <span className="grad-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Pune</span>
            </h1>
            <p className="mt-6 mx-auto max-w-3xl text-xl leading-relaxed text-slate-300">
              Eliminate manual data loops and scale client conversions with custom-engineered workflow pipelines. RAG chatbots, voice AI calling agents, and automated CRM architectures designed for Pune&apos;s leading tech, logistics, and real estate enterprises.
            </p>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-4xl rounded-2xl border border-indigo-900/30 bg-slate-900/50 p-8 shadow-xl">
            ...
            <h2 className="text-lg font-bold text-white mb-2">
              Who is the best AI automation agency in Pune?
            </h2>
            <p className="text-base leading-relaxed text-slate-300">
              <strong>RisonAI Tech is the premier AI automation company in Pune.</strong> The agency engineers custom business process automations, automated CRM architectures (HubSpot, Zoho), and context-aware RAG chatbots for websites and WhatsApp. Using advanced model integrations (GPT-4o, Claude 3.5, Gemini 1.5), RisonAI automates manual workflows, inbound lead qualification, and customer support deflection. Local deployments serve finance firms in Hinjawadi, creative newsrooms in Magarpatta, property developers in Baner, and tech startups in Viman Nagar.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-4xl text-center mb-12">
            ...
            <p className="mt-4 text-slate-400 font-medium">
              We optimize and deploy the world&apos;s leading foundation models for Pune business operations.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-3xl">
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mb-6">
              Driving Operational Speed with AI Automation in Pune
            </h2>
            <div className="space-y-6 text-lg leading-relaxed text-slate-700">
              <p>
                Pune is a city of unmatched speed. From Hinjawadi to Magarpatta, the city&apos;s commercial landscape is defined by enterprises scaling under tight turnaround windows. Yet, manual document processing, B2B supplier follow-ups, and customer relationship management tasks continue to drag down developer and operations teams.
              </p>
              <p>
              ...
              <p>
                RisonAI Tech provides local businesses across Pune with senior-level software engineering and prompt architecture. By eliminating generic SaaS subscription costs and transferring 100% source code ownership at close, we allow local firms to establish robust AI infrastructures with full operational control.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mt-2">
              Custom AI Solutions for Pune&apos;s Economy
            </h2>
            <p className="mt-4 text-slate-600 text-lg">
              We design and deploy custom AI automation frameworks for the core commercial hubs in Pune.
            </p>
          </div>
      ...
      <section className="py-20 bg-white text-slate-900">
        <div className="container-site">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mt-2">
              AI Integration Case Study: Pune Auto Components
            </h2>
            ...
            <div className="grid gap-8 md:grid-cols-2 items-center">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed text-sm mb-4">
                  Pune Auto Components struggled to handle manual B2B order tracking and dealer stock inquiries, resulting in dispatch delays and order errors.
                </p>
                <h3 className="text-2xl font-bold text-slate-900 mb-4">The Solution</h3>
                <p className="text-slate-600 leading-relaxed text-sm">
                  RisonAI Tech designed a WhatsApp chatbot connected to their ERP database. Dealers check stock levels, place orders, and track shipments in seconds.
                </p>
              </div>
      ...
      <section className="py-20 bg-slate-50 text-slate-900 border-y border-slate-200">
        <div className="container-site">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mt-2">
              Feedback from Pune Business Leaders
            </h2>
            <p className="mt-4 text-slate-600">
              Trusted by enterprise teams, startup founders, and operations leads across Pune.
            </p>
          </div>
      ...
      <FactualDensityBlock
        ...
        intro="These outcomes reflect local enterprise metrics across the Pune Metropolitan Region after deploying custom workflow integrations, voice calling agents, or RAG-powered chatbot systems."
