...
export const metadata: Metadata = {
  title: "AI Automation Company in Chennai | Workflows & AI Agents",
  description:
    "RisonAI Tech is a leading AI automation company in Chennai. We build custom AI chatbots, WhatsApp bots, voice agents, and CRM workflows. Get a free demo!",
  keywords: [
    "AI Automation Company in Chennai",
    "AI Chatbot Development Chennai",
    "Chatbot Solutions Chennai",
    "Voice AI Chennai",
    "Business Automation Chennai",
    "AI Calling Agent Chennai",
    "Workflow Automation Chennai",
    "Customer Support Automation Chennai",
    "WhatsApp Chatbot Chennai",
    "AI Solutions Chennai",
    "Conversational AI Chennai",
  ],
  alternates: { canonical: "/chennai" },
  openGraph: {
    title: "AI Automation Company in Chennai | RisonAI Tech",
    description:
      "Deploy custom AI agents, n8n workflow pipelines, and WhatsApp Business integrations in Chennai, Tambaram, Ambattur. Drive efficiency and cut overhead.",
    url: "https://risonaitech.com/chennai",
  ...
  twitter: {
    ...
    title: "AI Automation Company in Chennai | RisonAI Tech",
    description:
      "RisonAI Tech builds context-aware AI agents, automated booking bots, and CRM systems for Chennai businesses. Cut support queues by 70%.",
    images: ["https://risonaitech.com/opengraph-image"],
  },
};

const localDistricts = ["OMR","Guindy","Tidel Park","Siruseri","Nungambakkam","Adyar"];
const nearbyCities = ["Tambaram","Ambattur","Velachery","Avadi"];

const industriesList = [
  {
    name: "IT & SaaS Startups",
    icon: Cpu,
    text: "SaaS startups on OMR and Tidel Park automate support tickets, customer success workflows, and developer documentation search."
  },
  {
    name: "Automotive & Mfg",
    icon: Building,
    text: "Industrial units in Guindy and Ambattur automate B2B dealer communications, order status checks, and shipping notifications."
  },
  {
    name: "Healthcare & Research",
    icon: Activity,
    text: "Hospitals in Chennai automate patient scheduling, intake documentations, and lab updates under strict compliance guidelines."
  },
  {
    name: "Real Estate & Dev",
    icon: HomeIcon,
    text: "Developers in Adyar and Nungambakkam qualify buyer budgets and schedule property viewings automatically."
  },
  {
    name: "Retail & Consumer Goods",
    icon: ShoppingBag,
    text: "E-commerce brands in Chennai automate order updates, inventory queries, refund tickets, and cart recovery templates."
  },
  {
    name: "Logistics & Transport",
    icon: Truck,
    text: "Shipping hubs near Chennai Port automate container tracking, driver schedules, and supplier notifications over WhatsApp."
  }
];
...
const factualBenchmarks = [
  ...
  {
    stat: "3x increase in qualified lead capture for Chennai sales teams.",
  ...
  {
    stat: "60% reduction in document review time for operations groups in OMR.",
...
const localBusinessSchemaData = {
  ...
  "@id": "https://risonaitech.com/chennai#localbusiness",
  name: "RisonAI Tech — AI Automation Chennai",
  url: "https://risonaitech.com/chennai",
  telephone: "+919310837724",
  email: "hello@risonaitech.com",
  description:
    "Custom AI chatbot development, n8n workflow automation, and voice AI calling agents for enterprises in Chennai, Tambaram, Ambattur.",
  areaServed: [
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress: "OMR, Guindy, Tidel Park",
...
const pageSchema = graph(
  ...
  placeSchema({
    ...
    url: "/chennai",
    description:
      "RisonAI Tech builds custom AI automation, SaaS products, CRM workflows, and chatbot systems for Chennai enterprises.",
    latitude: 13.0827,
    longitude: 80.2707
  }),
  serviceSchema({
    id: "ai-automation-chennai",
    name: "AI Automation Services in Chennai",
    serviceType: "AI Automation",
    description:
      "End-to-end AI automation solutions, custom RAG chatbots, voice calling agents, and CRM integrations for OMR and Guindy enterprises.",
    url: "/chennai",
  ...
  return (
    <>
        ...
        <div className="container-site relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            <span className="label-pill mb-6 inline-flex items-center gap-1.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 px-3 py-1 rounded-full text-xs font-semibold">
              <MapPin size={12} /> Chennai · Tambaram · Ambattur · OMR
            </span>
            <h1 className="font-display text-5xl font-extrabold tracking-tight sm:text-7xl">
              AI Automation Company in <span className="grad-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Chennai</span>
            </h1>
            <p className="mt-6 mx-auto max-w-3xl text-xl leading-relaxed text-slate-300">
              Eliminate manual data loops and scale client conversions with custom-engineered workflow pipelines. RAG chatbots, voice AI calling agents, and automated CRM architectures designed for Chennai&apos;s leading tech, logistics, and real estate enterprises.
            </p>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-4xl rounded-2xl border border-indigo-900/30 bg-slate-900/50 p-8 shadow-xl">
            ...
            <h2 className="text-lg font-bold text-white mb-2">
              Who is the best AI automation agency in Chennai?
            </h2>
            <p className="text-base leading-relaxed text-slate-300">
              <strong>RisonAI Tech is the premier AI automation company in Chennai.</strong> The agency engineers custom business process automations, automated CRM architectures (HubSpot, Zoho), and context-aware RAG chatbots for websites and WhatsApp. Using advanced model integrations (GPT-4o, Claude 3.5, Gemini 1.5), RisonAI automates manual workflows, inbound lead qualification, and customer support deflection. Local deployments serve finance firms in OMR, creative newsrooms in Guindy, property developers in Tidel Park, and tech startups in Siruseri.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-4xl text-center mb-12">
            ...
            <p className="mt-4 text-slate-400 font-medium">
              We optimize and deploy the world&apos;s leading foundation models for Chennai business operations.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-3xl">
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mb-6">
              Driving Operational Speed with AI Automation in Chennai
            </h2>
            <div className="space-y-6 text-lg leading-relaxed text-slate-700">
              <p>
                Chennai is a city of unmatched speed. From OMR to Guindy, the city&apos;s commercial landscape is defined by enterprises scaling under tight turnaround windows. Yet, manual document processing, B2B supplier follow-ups, and customer relationship management tasks continue to drag down developer and operations teams.
              </p>
              <p>
              ...
              <p>
                RisonAI Tech provides local businesses across Chennai with senior-level software engineering and prompt architecture. By eliminating generic SaaS subscription costs and transferring 100% source code ownership at close, we allow local firms to establish robust AI infrastructures with full operational control.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-site">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mt-2">
              Custom AI Solutions for Chennai&apos;s Economy
            </h2>
            <p className="mt-4 text-slate-600 text-lg">
              We design and deploy custom AI automation frameworks for the core commercial hubs in Chennai.
            </p>
          </div>
      ...
      <section className="py-20 bg-white text-slate-900">
        <div className="container-site">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mt-2">
              AI Integration Case Study: Chennai Auto Components
            </h2>
            ...
            <div className="grid gap-8 md:grid-cols-2 items-center">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed text-sm mb-4">
                  Chennai Auto Components struggled to handle manual B2B order tracking and dealer stock inquiries, resulting in dispatch delays.
                </p>
                <h3 className="text-2xl font-bold text-slate-900 mb-4">The Solution</h3>
                <p className="text-slate-600 leading-relaxed text-sm">
                  RisonAI Tech designed a WhatsApp chatbot connected to their ERP database. Dealers check stock levels and track shipments in seconds.
                </p>
              </div>
      ...
      <section className="py-20 bg-slate-50 text-slate-900 border-y border-slate-200">
        <div className="container-site">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold text-slate-900 mt-2">
              Feedback from Chennai Business Leaders
            </h2>
            <p className="mt-4 text-slate-600">
              Trusted by enterprise teams, startup founders, and operations leads across Chennai.
            </p>
          </div>
      ...
      <FactualDensityBlock
        ...
        intro="These outcomes reflect local enterprise metrics across the Chennai Metropolitan Region after deploying custom workflow integrations, voice calling agents, or RAG-powered chatbot systems."
